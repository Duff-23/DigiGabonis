      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Une agence digitale 100% gabonaise spécialisée dans la création de sites web professionnels, modernes et sur mesure.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-digigabonis-green transition-colors">Création de site web</a></li>
              <li><a href="#" className="hover:text-digigabonis-green transition-colors">Sites e-commerce</a></li>
              <li><a href="#" className="hover:text-digigabonis-green transition-colors">Refonte de sites</a></li>
              <li><a href="#" className="hover:text-digigabonis-green transition-colors">SEO & Référencement</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li className="flex items-center">
                <svg className="w-5 h-5 mr-2 text-digigabonis-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="border-t border-gray-800 pt-6">
          <p className="text-gray-500 text-center">
            &copy; {currentYear} DigiGabonis - Le digital au service du Gabon
          </p>
        </div>
      </div>
    </footer>
